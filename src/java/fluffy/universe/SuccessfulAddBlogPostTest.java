...
public class SuccessfulAddBlogPostTest {
  ...
  public void successfulAddBlogPost() {
    ...
    driver.findElement(By.cssSelector(".post-form__title")).click();
    {
      ...
      js.executeScript("if(arguments[0].contentEditable === 'true') {arguments[0].innerText = 'Some post 2'}", element);
    }
    driver.findElement(By.cssSelector(".post-form__description")).click();
    {
      ...
      js.executeScript("if(arguments[0].contentEditable === 'true') {arguments[0].innerText = 'description'}", element);
    }
    ...
    assertThat(driver.findElement(By.cssSelector(".card:nth-child(1) .card__heading")).getText(), is("Some post 2"));
  }
}
